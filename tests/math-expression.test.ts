import { CaptchaMathExpression, ICaptchaMathExpressionOperators } from "../src/expressions/math-expression";
...
describe("CaptchaMathExpression", () => {
  ...
  describe("solve", () => {
    ...
    it("throws an error on unknown operators", () => {
      const expression = new CaptchaMathExpression([5, 8], ["*" as Partial<ICaptchaMathExpressionOperators>]);
